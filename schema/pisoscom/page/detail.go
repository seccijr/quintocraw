...
const (
	ID_SELECT = "[name*='IdPiso']"
	THUMB_SELECT = ".frame.slideShow img"
	PHOTO_URL_PRE = "http://fotos.imghs.net/"
	PHOTO_REGEXP = "(s|m|l|xl)"
	TELF_ENC_SELECT = "[id='tlfEnc']"
	TELF_TXT_SELECT = ".number.one"
	DESC_BOD_SELECT = ".descriptionBlock .description"
)
